...
class Wav{
  ...
  public function getLink() {
   ...
   public function WAvAudio(){
      system("/home/black-jack/.pyenv/versions/3.11.2/bin/python3.11 /home/black-jack/05-Script/03-Altrui/yt-dlp/yt_dlp/__main__.py -x --audio-format " . $this->wav . " -P /home/black-jack/05-Script/DuTube/Downloads " . $this->link);
   }}
