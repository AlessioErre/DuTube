...
class Ogg{
  ...
  public function getLink() {
   ...
   public function OggAudio(){
      system("python3 /home/black-jack/05-Script/03-Altrui/yt-dlp/yt_dlp/__main__.py -x --audio-format " . $this->ogg . " -P /home/black-jack/05-Script/DuTube/Downloads " . $this->link);
   }}
