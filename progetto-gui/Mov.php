...
class Mov{
  ...
  public function getLink() {
   ...
   public function MovAudio(){
      system("python3 /home/black-jack/05-Script/03-Altrui/yt-dlp/yt_dlp/__main__.py --recode-video " . $this->mov . " -P /home/black-jack/05-Script/DuTube/Downloads " . $this->link);
   }}
