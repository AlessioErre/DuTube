...
class Wma{
  ...
  public function getLink() {
   ...
   public function WmaAudio(){
      system("python3 /home/black-jack/05-Script/03-Altrui/yt-dlp/yt_dlp/__main__.py -x --audio-format " . $this->wma . " -P /home/black-jack/05-Script/DuTube/Downloads " . $this->link);
   }}
